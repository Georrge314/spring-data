...
public class WizardDeposits extends BaseEntity {
    ...
    @Column(name = "deposit_invest")
    public double getDepositInvest() {
        return depositInvest;
    }

    public void setDepositInvest(double depositInvest) {
        this.depositInvest = depositInvest;
    }
